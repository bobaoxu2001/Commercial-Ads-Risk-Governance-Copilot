...
CATEGORIES = (
    RiskCategory("Deceptive / Misleading Claims", "欺骗性或误导性声明", ("guaranteed", "guarantee", "risk-free", "instant results", "miracle", "no risk", "100%", "稳赚", "保本", "根治")),
    RiskCategory("Financial Scam / High-Risk Financial Services", "金融诈骗或高风险金融服务", ("investment", "crypto", "loan", "credit repair", "debt relief", "payday", "forex", "double your money", "秒批", "无视征信", "黑户可贷", "上岸", "返利")),
    ...
    RiskCategory("Dangerous Products or Services", "危险产品或服务", ("weapon", "explosive", "illegal drug", "hack account", "枪", "炸药")),
